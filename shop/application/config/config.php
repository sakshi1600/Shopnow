...
|
*/
$config['base_url'] = 'http://localhost/shopnow/shop/';
...
$config['csrf_exclude_uris'] = array("Login","HeadController/savedata","HeadController/update/.","MemberController/savedata/'.","MemberController/update/'.");
